  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A]">
      ...
      <section className="max-w-xl mx-auto px-6 pt-20 pb-24 text-center">
        ...
        <h1 className="heading-serif text-5xl tracking-tight mb-4">
          Accès complet
        </h1>
        <p className="text-white/60 mb-10">
          Découvrir, créer des Flares, chatter, Concierge et Vault.
        ...
        <div className="glass rounded-[2rem] p-10 border border-[#C5A46E]/25 text-left">
          ...
          <ul className="space-y-3 text-sm text-white/80 mb-8">
            <li className="flex items-center gap-3">
              <span className="text-[#C5A46E]">✓</span> Découvrir les Flares actifs
            </li>
            <li className="flex items-center gap-3">
              <span className="text-[#C5A46E]">✓</span> Créer tes propres Flares
            </li>
            <li className="flex items-center gap-3">
              <span className="text-[#C5A46E]">✓</span> Chat privé et éphémère
            </li>
            <li className="flex items-center gap-3">
              <span className="text-[#C5A46E]">✓</span> Concierge personnel
            </li>
            <li className="flex items-center gap-3">
              <span className="text-[#C5A46E]">✓</span> Vault chiffré
            </li>
            <li className="flex items-center gap-3">
              <span className="text-[#C5A46E]">✓</span> Vérification d'identité incluse
            </li>
          </ul>
